    ...
    <div onClick={() => handleClick()} className="card-listing">
      ...
      <div className="card-image-wrapper">
          <img
            ...
            loading="lazy"
          />
          {hostThumbnail !== "" && hostThumbnail !== undefined ? <img className="user-badge" style={{width: '45px', borderRadius: '100%'}} src={hostThumbnail} /> :
            <div className="user-badge" style={{width: '45px', borderRadius: '100%', padding: '3px 0px'}} >{userState && userState.user?.first_name && userState.user.first_name !== ""? userState.user.first_name[0] : "T"}</div>
          }
      </div>
      <div className="card-content">
        <div style={{display: 'flex', justifyContent: 'space-between'}}>
          ...
          <div style={{display: 'flex', alignItems: 'center'}}>
            ...
            {rating && rating >= 4 && <img style={{width: '15px', height: '15px'}} src={dynamicImgSrc('star-24.png')} />}
          </div>
        </div>
